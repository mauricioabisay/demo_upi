...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="<?php echo get_stylesheet_directory_uri();?>/img/golf_bag.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo get_stylesheet_directory_uri();?>/img/horse_sadle.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo get_stylesheet_directory_uri();?>/img/golf_shoot.jpg" alt="Third slide">
    </div>
  </div>
...
<div id="golf" class="mv-section golf">
  <div class="row title">
    <h2>Golf</h2>
  </div>
  <div class="row desc">
...
<div id="equitacion" class="mv-section horse">
  <div class="row title">
    <h2>Equitacion</h2>
  </div>
  <div class="row desc">
